...
export default function Navbar({ locale }) {
  ...
  return (
    <div className="fixed w-full top-0 left-0 px-[50px] py-[15px] flex justify-between items-center backdrop-blur-[12px] bg-[rgba(255,255,255,0.5)] border-b border-[rgba(0,0,0,0.05)] z-[999]">
      ...
      <button
        ...
        className="ml-2 rounded-full bg-[#85754E] px-4 py-2 text-xs font-bold text-white"
      >
