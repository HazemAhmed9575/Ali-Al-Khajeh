...
export default function Steps({ messages, locale }) {
  ...
  const steps = [
    {
      num: 1,
      titleKey: "process.steps.review.title",
      descKey: "process.steps.review.desc",
    },
    {
      num: 2,
    ...
    {
      num: 3,
      titleKey: "process.steps.action.title",
      descKey: "process.steps.action.desc",
    }
  ];
