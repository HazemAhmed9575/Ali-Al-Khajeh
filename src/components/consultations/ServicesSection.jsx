        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            <span className="text-[#85754E] font-bold tracking-wider uppercase mb-2 block">
              {t(messages, "consultations.services.badge")}
            </span>
          ...
          >
            {t(messages, "consultations.services.viewAll")}
            <FiArrowLeft />
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group relative overflow-hidden rounded-2xl cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-6 flex flex-col justify-end">
              ...
              <h3 className="text-white font-display font-bold text-xl mb-1">
                {t(messages, "consultations.services.items.divorce.title")}
              </h3>
              <p className="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                {t(messages, "consultations.services.items.divorce.desc")}
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-6 flex flex-col justify-end">
              ...
              <h3 className="text-white font-display font-bold text-xl mb-1">
                {t(messages, "consultations.services.items.custody.title")}
              </h3>
              <p className="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                {t(messages, "consultations.services.items.custody.desc")}
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-6 flex flex-col justify-end">
              ...
              <h3 className="text-white font-display font-bold text-xl mb-1">
                {t(messages, "consultations.services.items.will.title")}
              </h3>
              <p className="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                {t(messages, "consultations.services.items.will.desc")}
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-6 flex flex-col justify-end">
              ...
              <h3 className="text-white font-display font-bold text-xl mb-1">
                {t(messages, "consultations.services.items.marriage.title")}
              </h3>
              <p className="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                {t(messages, "consultations.services.items.marriage.desc")}
              </p>
            </div>
          </div>
        </div>
