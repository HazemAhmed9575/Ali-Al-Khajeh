...
const REVIEW_LINKS = [
  "https://maps.app.goo.gl/4hxTJ5n1uXNjPWnP7",
  "https://maps.app.goo.gl/p5nxy5hH7uqTFkyx9",
  "https://maps.app.goo.gl/vq1ht8cnPyFF9epc9",
  "https://maps.app.goo.gl/9xwcAXPZHwdzbSaw5",
  "https://maps.app.goo.gl/5neScfrwVhKTGEDq8",
];

// ✅ صورك (اختياري)
const AVATARS = [
  "https://lh3.googleusercontent.com/a/ACg8ocJLSL8hMdge5qGbc24ore9MGBuesFHX4IkBaxbHmx_cLyrcHw=w38-h38-p-rp-mo-br100",
  "https://lh3.googleusercontent.com/a/ACg8ocKILUNIlNeRsaveg_2WZGs43WokrDOm42IVA8tTUfsV3nPzTQ=w38-h38-p-rp-mo-br100",
  "https://lh3.googleusercontent.com/a-/ALV-UjUGe7sgsEywc6sd35-V61kX4P00B1cKcJEvvdPrfDIiND2hkHw=w38-h38-p-rp-mo-br100",
  "https://lh3.googleusercontent.com/a/ACg8ocIlxgJ9wN35-UT29gwqXe7WkhmCB7OIGGrsEOJ9PpEQ8wz40Lw=w38-h38-p-rp-mo-br100",
  "https://lh3.googleusercontent.com/a-/ALV-UjVEYKPlT13hl5usoLOJaTUcNhxEqNOF61W4lG8mpATZEfRwM___=w38-h38-p-rp-mo-br100",
];
...
export default function GoogleReviews({ messages, locale }) {
  ...
  const items = t(messages, "consultations.Reviews.items") || [];
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-8">
          <div>
            ...
            <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mt-1">
              {t(messages, "consultations.Reviews.title")}
            </h2>
          </div>
