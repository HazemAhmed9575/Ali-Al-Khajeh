  ...
  const services = [
    {
      ...
      titleKey: "corporateIssues.services.items.business.title",
    },
    {
      icon: FaPeopleRoof,
      titleKey: "corporateIssues.services.items.family.title",
    },
    {
      icon: FaShieldHalved,
      titleKey: "corporateIssues.services.items.insurance.title",
    },
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-12 lg:px-20">
        ...
        <div className="text-center mb-14">
          <h2 className="text-[#d8a55b] font-serif text-[28px] md:text-[34px] font-semibold">
            {t(messages, "corporateIssues.services.title")}
          </h2>
        </div>
