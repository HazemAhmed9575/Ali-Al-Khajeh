...
export default function Navbar({ messages, locale }) {
  ...
  return (
    ...
    text-white hover:bg-white/30 transition-all duration-300">
              ...
              {openMenu && (
                <div
                  className="absolute top-11  z-[99999]  bg-white rounded-xl shadow-xl border overflow-hidden"
                  ...
                  <button
                    ...
                    onClick={async (e) => {
                      ...
                      await trackClick({
                        type: openMenu === "wa" ? "wa" : "call",
                        number: "+971503090203",
                      });

                      if (openMenu === "wa") {
                        window.open("https://wa.me/971503090203", "_blank");
                      } else {
                        window.location.href = "tel:+971503090203";
                      }
                    }}>
                    0503090203
                  </button>
                  ...
                  <button
                    ...
                    onClick={async (e) => {
                      ...
                      if (openMenu === "wa") {
                        window.open("https://wa.me/971547477777", "_blank");
                      } else {
                        window.location.href = "tel:+971547477777";
                      }
                    }}>
                    0547477777
                  </button>
