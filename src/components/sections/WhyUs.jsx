...
export default function WhyUs({ messages, locale }) {
  ...
  const cards = [
    {
      icon: FaLocationDot,
      titleKey: "whyChoose.cards.confidentiality.title",
      descKey: "whyChoose.cards.confidentiality.desc",
    },
    {
      icon: FaClock,
      titleKey: "whyChoose.cards.strategy.title",
      descKey: "whyChoose.cards.strategy.desc",
    },
    {
      icon: FaCircleCheck,
      titleKey: "whyChoose.cards.results.title",
      descKey: "whyChoose.cards.results.desc",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-16 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden aspect-square">
            ...
            <Image
              ...
              alt={t(messages, "whyChoose.imageAlt")}
              fill
