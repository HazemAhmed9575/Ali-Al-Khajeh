      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="text-[#85754E] font-bold tracking-wider uppercase mb-2 block">
            {t(messages, "personalStatus.process.badge")}
          </span>
          <h2 className="font-display font-bold text-3xl md:text-4xl text-gray-900">
            {t(messages, "personalStatus.process.title")}
          </h2>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-display font-bold text-xl text-gray-900 mb-3">
                {t(messages, "personalStatus.process.steps.step1.title")}
              </h3>
              <p className="text-gray-600 text-sm px-4">
                {t(messages, "personalStatus.process.steps.step1.desc")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-display font-bold text-xl text-gray-900 mb-3">
                {t(messages, "personalStatus.process.steps.step2.title")}
              </h3>
              <p className="text-gray-600 text-sm px-4">
                {t(messages, "personalStatus.process.steps.step2.desc")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-display font-bold text-xl text-gray-900 mb-3">
                {t(messages, "personalStatus.process.steps.step3.title")}
              </h3>
              <p className="text-gray-600 text-sm px-4">
                {t(messages, "personalStatus.process.steps.step3.desc")}
              </p>
            </div>
