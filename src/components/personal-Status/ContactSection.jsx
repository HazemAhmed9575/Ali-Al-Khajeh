      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-10 md:p-14 flex flex-col justify-center bg-[#85754E] text-white">
            ...
            <a href="tel:+971503090203" className="flex items-center justify-center gap-3 bg-white text-[#85754E] font-bold py-4 px-6 rounded-xl shadow-lg hover:bg-gray-100 transition">
              <FiPhoneCall />
              {t(messages, "personalStatus.contact.call")}
            </a>

            <a href="https://wa.me/971503090203" className="mt-4 flex items-center justify-center gap-3 bg-[#25D366] text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:bg-[#20bd5a] transition">
              <FaWhatsapp />
              {t(messages, "personalStatus.contact.whatsapp")}
            </a>
          </div>
...
<textarea
  name="message"
  rows={4}
  placeholder={t(messages, "personalStatus.contact.form.message")}
...
/>
              ...
              >
                {loading ? "Sending..." : t(messages, "personalStatus.contact.form.submit")}
              </button>
            </form>
          </div>
        </div>
